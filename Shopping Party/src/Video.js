        ...
        {this.state.askForUsername === true ? (
          <div >
            ...
            >
              ...
              >
                <video
                  ...
                  style={{
                    ...
                    borderColor: "#bdbdbd",
                    objectFit: "fill",
                    width: "400px", // Set a fixed width to fit the container
                    height: "auto",
                  }}
                ></video>
              </div>
              ...
              >
                <p style={{ margin: 0, fontWeight: "bold" }}>Enter your name</p>
                <Input
          ...
          <div>
            ...
            >
              <Button
                  style={{
                    backgroundColor: "rgb(250, 61, 115)",
                    color: "white",
                    paddingLeft: "12px",
                    paddingTop: "10px",
                    width: "150px",
            ...
            >
              <Modal.Header closeButton>
                <Modal.Title>Chat With Friends</Modal.Title>
              </Modal.Header>
              <Modal.Body
                style={{
                  overflow: "auto",
              ...
              <Modal.Footer className="div-send-msg">
                ...
                <Button
                  ...
                  style={{ background: "rgb(250, 61, 115)", color: "white" }}
                >
                  Send
                </Button>
              </Modal.Footer>
